	...
	<body>
		...
		<div id="restricted-country">
			 ...
			 <p id="message">
				...
				<img src="{$content_dir}img/admin/tab-tools.gif" class="f_left" />{l s='Você não pode acessar esta loja a partir do seu país. Pedimos desculpas pelo inconveniente.'}

...
{capture assign='page_title'}{l s='Frete:'}{/capture}
...
<div data-role="content" id="delivery_choose">
	<h3  class="bg">{l s='Escolha o seu método de entrega'}</h3>
	...
	<fieldset data-role="fieldcontain">
		...
		<label for="recyclable">{l s='Concordo em receber a minha encomenda em embalagens recicladas'}.</label>
	</fieldset>
	...
	{if $giftAllowed}
		...
		<p class="checkbox">
			...
			<label for="gift">{l s='Gostaria que o meu produto fosse embrulhado para presente.'}</label>
			<br />
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<h3 class="bg">{l s='Termos de serviço'}</h3>
	<fieldset data-role="fieldcontain" id="cgv_checkbox">
		...
		<label for="cgv">{l s='Eu concordo com os termos de serviço e vai cumpri-los incondicionalmente.'}</label>
	</fieldset>
	<p class="lnk_CGV"><a href="{$link_conditions}" data-ajax="false">{l s='(Leia os termos de serviço)'}</a></p>
</div>

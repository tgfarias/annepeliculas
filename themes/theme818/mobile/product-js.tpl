...
function initProductPage()
{
	...
	// Translations
	ProductFn.doesntExist = '{l s='A combinação não existe para este produto. Por favor, escolha outro.' js=1}';
	ProductFn.doesntExistNoMore = '{l s='Este produto não está mais em estoque' js=1}';
	ProductFn.doesntExistNoMoreBut = '{l s='com esses atributos, mas está disponível com os outros' js=1}';
	ProductFn.uploading_in_progress = '{l s='Upload em andamento, por favor aguarde...' js=1}';
	ProductFn.fieldRequired = '{l s='Por favor, preencha todos os campos, em seguida, salvar a sua personalização.' js=1}';

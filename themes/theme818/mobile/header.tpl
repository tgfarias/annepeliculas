			...
			<div class="ui-grid-a">
				...
				<div class="ui-block-b">
					<div id="block_cart" class="clearfix">
						{if !$PS_CATALOG_MODE}
						<a href="{$link->getPageLink('order-opc', true)}" class="link_cart" data-ajax="false">{l s='Carrinho'}</a>
						{/if}
						{if $logged}
							<a href="{$link->getPageLink('my-account', true)}" class="link_account" data-ajax="false">{l s='Minha Conta'}</a>
						{else}
							<a href="{$link->getPageLink('authentication', true)}" class="link_account" data-ajax="false">{l s='Login'}</a>
						{/if}
					</div>

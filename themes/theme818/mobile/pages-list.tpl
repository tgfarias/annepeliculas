...
*}
		...
		<hr/>
		<h2 class="site_map">{l s='Mapa do site'}</h2>
		<ul data-role="listview" data-inset="true" id="category">
			...
			{if $controller_name != 'my-account'}<li><a href="{$link->getPageLink('my-account', true)}" data-ajax="false">{l s='Minha Conta'}</a></li>{/if}
			{if $controller_name != 'contact'}<li><a href="{$link->getPageLink('contact', true)}" data-ajax="false">{l s='Contato'}</a></li>{/if}
		</ul>

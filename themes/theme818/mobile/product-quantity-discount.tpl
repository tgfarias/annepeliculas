...
<ul class="idTabs clearfix">
	<li><a href="#discount" style="cursor: pointer" class="selected" data-ajax="false">{l s='Descontos'}</a></li>
</ul>
<div id="quantityDiscount">
	<table class="std">
		<thead>
			<tr>
				<th>{l s='produto'}</th>
				<th>{l s='a partir de (qnt)'}</th>
				<th>{l s='desconto'}</th>
			</tr>
		</thead>
		<tbody>
			<tr id="noQuantityDiscount">
				<td colspan='3'>{l s='Não há desconto de quantidade para este produto.'}</td>
			</tr>

...
*}
			...
			<div id="footer">
				...
				<div id="full-site-section" class="center">
					<a href="{$link->getPageLink('index', true)}?no_mobile_theme" data-ajax="false">{l s='Navegue no site completo'}</a>
				</div>
				...
				<div data-role="footer" data-theme="a" id="bar_footer">
					<div id="link_bar_footer" class="ui-grid-a">
						...
						<div class="ui-block-b">
							<a href="{$link->getCMSLink($id_cgv)}" data-ajax="false">{l s='Termos de serviço'}</a>
						</div>
						{/if}
					</div>
				</div>

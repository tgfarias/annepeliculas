	...
	<body>
		...
		<div id="maintenance" class="container">
			 ...
			 <p id="message">
				...
				<h2>{l s='Para realizar a manutenção do site, a nossa loja on-line será temporariamente offline.'}</h2>

				<h3>{l s='Pedimos desculpas pelo inconveniente e pedimos que você tente novamente mais tarde.'}</h3>

	...
	<div id="pagination{if isset($paginationId)}_{$paginationId}{/if}" class="pagination">
	  ...
	  {if $start!=$stop}
		...
		{if $p != 1}
			...
			<li id="pagination_previous{if isset($paginationId)}_{$paginationId}{/if}" class="pagination_previous"><a class="button" {$no_follow_text} href="{$link->goPage($requestPage, $p_previous)}">{l s='Anterior'}</a></li>

		{else}

			<li id="pagination_previous{if isset($paginationId)}_{$paginationId}{/if}" class="disabled"><span class="button">{l s='Anterior'}</span></li>
		...
		{if $pages_nb > 1 AND $p != $pages_nb}
			...
			<li id="pagination_next{if isset($paginationId)}_{$paginationId}{/if}" class="pagination_next"><a class="button" {$no_follow_text} href="{$link->goPage($requestPage, $p_next)}">{l s='Próximo'}</a></li>

		{else}

			<li id="pagination_next{if isset($paginationId)}_{$paginationId}{/if}" class="disabled pagination_next"><span class="button">{l s='Próximo'}</span></li>

...
<form id="liveEdit-action-form" action="./{$ad}/index.php" method="post">
	...
	{/foreach}
<div >
	<input type="submit" value="{l s='Salvar'}" name="saveHook" id="saveLiveEdit" class="exclusive" style="color:#fff;float:right; text-shadow: 0 -1px 0 #157402; margin-right:20px;">
	<input type="submit" value="{l s='Fechar edição'}" id="closeLiveEdit" class="button" style="background: #333 none; color:#fff; border:1px solid #000; float:right; margin-right:10px;">
...
<div id="live_edit_feedback" style="width:400px"> 
	...
	<!-- <a href="javascript:;" onclick="$.fancybox.close();">{l s='Fechar'}</a> --> 
</div>	

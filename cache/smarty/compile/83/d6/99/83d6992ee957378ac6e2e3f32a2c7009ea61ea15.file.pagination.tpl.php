<?php /* Smarty version Smarty-3.1.19, created on 2014-11-15 23:27:46
         compiled from "/home/annepeliculas/www/site/themes/theme818/mobile/pagination.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8570269265467fd92ccb114-60458701%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '83d6992ee957378ac6e2e3f32a2c7009ea61ea15' => 
    array (
      0 => '/home/annepeliculas/www/site/themes/theme818/mobile/pagination.tpl',
      1 => 1415737276,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8570269265467fd92ccb114-60458701',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5467fd92ed5958_88212225',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5467fd92ed5958_88212225')) {function content_5467fd92ed5958_88212225($_smarty_tpl) {?>
...
<?php }?>" data-ajax="false"><?php echo smartyTranslate(array('s'=>'Anterior'),$_smarty_tpl);?>
</a>
		</li>
...
?>
			<?php if ($_smarty_tpl->tpl_vars['p']->value==$_smarty_tpl->getVariable('smarty')->value['section']['pagination']['index']) {?>
				<li class="current"><a href="#" data-role="button" class="ui-btn-active" data-ajax="false"><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['p']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</a></li>
			<?php } else { ?>
...
" data-ajax="false"><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->getVariable('smarty')->value['section']['pagination']['index'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</a></li>
			<?php }?>
		<?php endfor; endif; ?>
...
<?php }?>" data-ajax="false"><?php echo smartyTranslate(array('s'=>'Próximo'),$_smarty_tpl);?>
</a>
			</li>
		</ul>
	<?php }?>

<?php /* Smarty version Smarty-3.1.19, created on 2014-11-19 22:36:07
         compiled from "/home/annepeliculas/www/site/themes/theme818/mobile/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1607934930546d377763a031-62586756%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5bb92f1b294e0eff321e4c39ee8f0baba5e769b9' => 
    array (
      0 => '/home/annepeliculas/www/site/themes/theme818/mobile/product.tpl',
      1 => 1415737273,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1607934930546d377763a031-62586756',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_546d377791ff42_70117947',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_546d377791ff42_70117947')) {function content_546d377791ff42_70117947($_smarty_tpl) {?>

<?php $_smarty_tpl->_capture_stack[0][] = array('default', 'page_title', null); ob_start(); ?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
<?php echo $_smarty_tpl->getSubTemplate ('./product-js.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
<div data-role="content" id="content" class="product">
	...
	<?php echo $_smarty_tpl->getSubTemplate ("./product-images.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
	...
	<?php if (count($_smarty_tpl->tpl_vars['packItems']->value)>0) {?>
		...
		<div class="short_description_pack">
			<h3><?php echo smartyTranslate(array('s'=>'Conteúdo do Pacote'),$_smarty_tpl);?>
</h3>
...
" data-ajax="false"><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['packItem']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</a>
...
" id="product_page_product_id" />
		...
		<div class="clearfix">
			...
			<?php echo $_smarty_tpl->getSubTemplate ("./product-attributes.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
			...
			<div id="quantity_wanted_p"<?php if ((!$_smarty_tpl->tpl_vars['allow_oosp']->value&&$_smarty_tpl->tpl_vars['product']->value->quantity<=0)||$_smarty_tpl->tpl_vars['virtual']->value||!$_smarty_tpl->tpl_vars['product']->value->available_for_order||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> style="display: none;"<?php }?>>
				<label for="qty" class=""><?php echo smartyTranslate(array('s'=>'Quantidade:'),$_smarty_tpl);?>
</label>
...
<?php } else { ?>1<?php }?><?php }?>" />
 ...
 <b id="minimal_quantity_label"><?php echo $_smarty_tpl->tpl_vars['product']->value->minimal_quantity;?>
			...
			<div id="availability_statut"<?php if (($_smarty_tpl->tpl_vars['product']->value->quantity<=0&&!$_smarty_tpl->tpl_vars['product']->value->available_later&&$_smarty_tpl->tpl_vars['allow_oosp']->value)||($_smarty_tpl->tpl_vars['product']->value->quantity>0&&!$_smarty_tpl->tpl_vars['product']->value->available_now)||!$_smarty_tpl->tpl_vars['product']->value->available_for_order||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> style="display: none;"<?php }?>>
				<label id="availability_label" class=""><?php echo smartyTranslate(array('s'=>'Disponibilidade:'),$_smarty_tpl);?>
</label>
...
<?php }?>
			...
			<p id="pQuantityAvailable"<?php if ($_smarty_tpl->tpl_vars['product']->value->quantity<=0) {?> style="display: none;"<?php }?>>
				...
				<span <?php if ($_smarty_tpl->tpl_vars['product']->value->quantity==1) {?> style="display: none;"<?php }?> id="quantityAvailableTxtMultiple"><?php echo smartyTranslate(array('s'=>'Ítens em estoque'),$_smarty_tpl);?>
</span>
			</p>
			<?php }?>
			...
			<p class="warning_inline" id="last_quantities"<?php if (($_smarty_tpl->tpl_vars['product']->value->quantity>$_smarty_tpl->tpl_vars['last_qties']->value||$_smarty_tpl->tpl_vars['product']->value->quantity<=0)||$_smarty_tpl->tpl_vars['allow_oosp']->value||!$_smarty_tpl->tpl_vars['product']->value->available_for_order||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> style="display: none"<?php }?> ><?php echo smartyTranslate(array('s'=>'Aviso: Últimos artigos em estoque!'),$_smarty_tpl);?>
</p>
		...
		<?php if ($_smarty_tpl->tpl_vars['product']->value->show_price&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
			...
			<?php echo $_smarty_tpl->getSubTemplate ("./product-prices.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
" value="submit-value" id="Submit" <?php echo $_smarty_tpl->tpl_vars['cart_btn_icon']->value;?>
 ><?php echo smartyTranslate(array('s'=>'Adicionar ao carrinho'),$_smarty_tpl);?>
	...
	<?php echo $_smarty_tpl->getSubTemplate ("./product-quantity-discount.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>

	
	
	<hr/>
	<!-- description and features -->
	<?php echo $_smarty_tpl->getSubTemplate ("./product-desc-features.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
	...
	<hr class="margin_less"/>
	<div id="blockpack">
		<h2><?php echo smartyTranslate(array('s'=>'Conteúdo do pacote'),$_smarty_tpl);?>
</h2>
		<?php echo $_smarty_tpl->getSubTemplate ("./category-product-list.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('products'=>$_smarty_tpl->tpl_vars['packItems']->value), 0);?>

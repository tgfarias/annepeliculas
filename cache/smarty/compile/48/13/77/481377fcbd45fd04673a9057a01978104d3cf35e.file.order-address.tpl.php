<?php /* Smarty version Smarty-3.1.19, created on 2014-11-15 18:50:42
         compiled from "/home/annepeliculas/www/site/themes/theme818/order-address.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12673988765467bca20b68c6-56206852%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '481377fcbd45fd04673a9057a01978104d3cf35e' => 
    array (
      0 => '/home/annepeliculas/www/site/themes/theme818/order-address.tpl',
      1 => 1415369929,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12673988765467bca20b68c6-56206852',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5467bca25d5a98_25942933',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5467bca25d5a98_25942933')) {function content_5467bca25d5a98_25942933($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/home/annepeliculas/www/site/tools/smarty/plugins/function.counter.php';
?>
...
:<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['json_encode'][0][0]->jsonEncode($_smarty_tpl->tpl_vars['field_name']->value);?>
...

	{
		...
		return {
			...
			'invoice': "<?php echo smartyTranslate(array('s'=>'Seu endereço de cobrança','js'=>1),$_smarty_tpl);?>
",

			'delivery': "<?php echo smartyTranslate(array('s'=>'Seu endereço de entrega','js'=>1),$_smarty_tpl);?>
"
...
<?php }?>" title="<?php echo smartyTranslate(array('s'=>'Atualizar','js'=>1),$_smarty_tpl);?>
">&raquo; <?php echo smartyTranslate(array('s'=>'Atualizar','js'=>1),$_smarty_tpl);?>
</a>';
...
<?php $_smarty_tpl->_capture_stack[0][] = array('path', null, null); ob_start(); ?><?php echo smartyTranslate(array('s'=>'Endereços'),$_smarty_tpl);?>
...
<?php if (!$_smarty_tpl->tpl_vars['opc']->value) {?><h1><span><?php echo smartyTranslate(array('s'=>'Endereços'),$_smarty_tpl);?>
</span></h1><?php } else { ?><h1><span>1 <?php echo smartyTranslate(array('s'=>'Endereços'),$_smarty_tpl);?>
</span></h1><?php }?>
...
<?php $_tmp4=ob_get_clean();?><?php if (!$_smarty_tpl->tpl_vars['multi_shipping']->value&&$_tmp4&&!$_smarty_tpl->tpl_vars['cart']->value->isVirtualCart()) {?>
		...
		<div class="button_multishipping_mode titled_box" id="multishipping_mode_box">
			...
			<h2><span><?php echo smartyTranslate(array('s'=>'Multiplos-envios'),$_smarty_tpl);?>
</span></h2>

			<div class="description">

				<a class="button btn btn-default" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,'step=1&multi-shipping=1'), ENT_QUOTES, 'UTF-8', true);?>
"/>

					<?php echo smartyTranslate(array('s'=>'Especifique um endereço de entrega para cada produto encomendado.'),$_smarty_tpl);?>
...
<?php $_tmp5=ob_get_clean();?><?php if ($_tmp5&&!$_smarty_tpl->tpl_vars['cart']->value->isVirtualCart()) {?>
		...
		<div class="address-form-multishipping hidden-xs">
			...
			<div class="button_multishipping_mode" id="multishipping_mode_box">
				...
				<h4 class="title"><?php echo smartyTranslate(array('s'=>'Multiplos-envios'),$_smarty_tpl);?>
</h4>

				<div class="description">

					<input type="checkbox" id="multishipping_mode_checkbox" onchange="multishippingMode(this); return false;" autocomplete="off"/><label for="multishipping_mode_checkbox"><?php echo smartyTranslate(array('s'=>'Eu gostaria de especificar um endereço de entrega para cada produto encomendado.'),$_smarty_tpl);?>
</label>
...
" id="link_multishipping_form" class="button btn btn-default" title="<?php echo smartyTranslate(array('s'=>'Escolha o endereço de entrega(s)'),$_smarty_tpl);?>
">

						<?php echo smartyTranslate(array('s'=>'Especifique um endereço de entrega para cada produto.'),$_smarty_tpl);?>
...
<?php }?>
	...
	<div class="addresses clearfix">
		...
		<p class="address_delivery form-group">
			...
			<label for="id_address_delivery"><?php if ($_smarty_tpl->tpl_vars['cart']->value->isVirtualCart()) {?><?php echo smartyTranslate(array('s'=>'Escolha um endereço de pagamento:'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Escolha um endereço de entrega:'),$_smarty_tpl);?>
<?php }?></label>
...
" <?php if ($_smarty_tpl->tpl_vars['address']->value['id_address']==$_smarty_tpl->tpl_vars['cart']->value->id_address_delivery) {?>selected="selected"<?php }?>><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['address']->value['alias'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
		...
		<p class="checkbox-inline addressesAreEquals" <?php if ($_smarty_tpl->tpl_vars['cart']->value->isVirtualCart()) {?>style="display:none;"<?php }?>>
			...
			<label for="addressesAreEquals"><?php echo smartyTranslate(array('s'=>'Use o endereço de entrega, como o endereço de cobrança.'),$_smarty_tpl);?>
</label>
		...
		<?php if (count($_smarty_tpl->tpl_vars['addresses']->value)>1) {?>
			...
			<label for="id_address_invoice" class="strong"><?php echo smartyTranslate(array('s'=>'Escolha um endereço de pagamento:'),$_smarty_tpl);?>
</label>
...
" class="button_large btn btn-default"><?php echo smartyTranslate(array('s'=>'Add um novo endereço'),$_smarty_tpl);?>
</a>
		...
		<div class="row bottom_indent">
        	...
        	<div class="col-xs-12 col-sm-6">
                ...
                <ul class="address item clearfix" id="address_delivery" <?php if ($_smarty_tpl->tpl_vars['cart']->value->isVirtualCart()) {?>style="display:none;"<?php }?>>
            ...
            <div class="col-xs-12 col-sm-6">
				...
				<ul class="address alternate_item <?php if ($_smarty_tpl->tpl_vars['cart']->value->isVirtualCart()) {?>full_width<?php }?> clearfix" id="address_invoice">
...
" class="button_large btn btn-default"><?php echo smartyTranslate(array('s'=>'Add um novo endereço'),$_smarty_tpl);?>
		...
		<div id="ordermsg" class="clearfix form-group">
			...
			<textarea class="form-control" cols="60" rows="3" name="message"><?php if (isset($_smarty_tpl->tpl_vars['oldMessage']->value)) {?><?php echo $_smarty_tpl->tpl_vars['oldMessage']->value;?>
<?php }?></textarea>
...
" class="button btn btn-default">&laquo; <?php echo smartyTranslate(array('s'=>'Anterior'),$_smarty_tpl);?>
		...
		<input type="submit" name="processAddress" value="<?php echo smartyTranslate(array('s'=>'Próximo'),$_smarty_tpl);?>
